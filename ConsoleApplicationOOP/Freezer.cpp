...
Freezer::Freezer() :
    ...
    fillProperties(1, 11, "color", "country", 2);
}
...
Freezer::Freezer(int id, int price, string name, string description, int cam) :
    ...
    fillProperties(cam, 11, "color", "country", 2);
}
...
void Freezer::fillProperties(int cameras, int weight, string color, string country, int doors)
{
    _cameras = cameras;
    _weight = weight;
    _color = color;
